...
BOOK_ORDER = OrderedDict([
    ...
    ("JOSHUA SON OF NUN", "joshua.html"),
    ("JUDGES", "judges.html"),
    ("RUTH", "ruth.html"),
    ("1 KINGDOMS", "1-kingdoms.html"),
    ("2 KINGDOMS", "2-kingdoms.html"),
    ("3 KINGDOMS (1 KINGS)", "3-kingdoms.html"),
    ("4 KINGDOMS (2 KINGS)", "4-kingdoms.html"),
    ("1 PARALEIPOMENON (CHRONICLES)", "1-paraleipomenon.html"),
    ("2 PARALEIPOMENON (CHRONICLES)", "2-paraleipomenon.html"),
    ("1 ESDRAS (EZRA)", "1-esdras.html"),
    ("2 ESDRAS (EZRA)", "2-esdras.html"),
    ("NEHEMIAH", "nehemiah.html"),
    ("TOBIT", "tobit.html"),
    ("JUDITH", "judith.html"),
    ("ESTHER", "esther.html"),
    ("1 MACCABEES", "1-maccabees.html"),
    ("2 MACCABEES", "2-maccabees.html"),
    ("3 MACCABEES", "3-maccabees.html"),
    ("PSALMS", "psalms.html"),
    ("JOB", "job.html"),
    ("PROVERBS OF SOLOMON", "proverbs.html"),
    ("ECCLESIASTES", "ecclesiastes.html"),
    ("SONG OF SONGS", "song-of-songs.html"),
    ("WISDOM OF SOLOMON", "wisdom-of-solomon.html"),
    ("THE WISDOM OF SIRACH", "wisdom-of-sirach.html"),
    ("HOSEA", "hosea.html"),
    ("AMOS", "amos.html"),
    ("MICAH", "micah.html"),
    ("JOEL", "joel.html"),
    ...
    ("BARUCH", "baruch.html"),
    ("AN EPISTLE OF JEREMIAH", "epistle-of-jeremiah.html"),
    ("LAMENTATIONS OF JEREMIAH", "lamentations.html"),
    ("EZEKIEL", "ezekiel.html"),
    ("DANIEL", "daniel.html"),
    ("4 MACCABEES", "4-maccabees.html"),
    ("THE PRAYER OF MANASSEH KING OF JUDEA, WHILE BEING HELD IN THE CAPTIVITY OF BABYLON",
     "prayer-of-manasseh.html"),
    ("1 ESDRA", "1-esdra.html"),
    # The appendix Nehemiah is a distinct entry; we give it a different filename
    ("NEHEMIAH_APPENDIX", "nehemiah-appendix.html"),
    ("2 ESDRA", "2-esdra.html"),
])
